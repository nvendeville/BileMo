...
class ApiProductController extends AbstractFOSRestController
{
     ...
     * )
     */
    public function getProducts(CacheInterface $cache, ProductRepository $productRepository, ParamFetcher $paramFetcher): Response
    {
        return $cache->get('result-paginated-products', function(ItemInterface $item) use ($paramFetcher, $productRepository) {
